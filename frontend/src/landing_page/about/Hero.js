    ...
    return ( 
        <div className='container mt-4'>
            <div className='row p-5 mt-5'>
                ...
                <div className='mini-container p-5 mt-5 ' style={{lineHeight:"30px"}}>
                <div className='row px-5 mt-4 text-muted border-top'>
                <div className='col-6 p-5 mt-5' style={{fontSize:"17px"}}>
